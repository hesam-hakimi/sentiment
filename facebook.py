...
for offset in range(10, 1000000, 10):
    ...
    url = F"https://amp-api.apps.apple.com/v1/catalog/us/apps/284882215/reviews?l=en-US&offset={offset}&platform=web&additionalPlatforms=appletv%2Cipad%2Ciphone%2Cmac"
    ...
    headers = {
        ...
        'Cookie': 'geo=US',
        'path': '/v1/catalog/us/apps/284882215/reviews?l=en-US&offset={offset}&platform=web&additionalPlatforms=appletv,ipad,iphone,mac',
    ...
    with io.open('instagram.csv', '+a', encoding='utf-8', newline='') as f:
